# Build .NET 10 Web Apps with Blazor and Minimal API - Syllabus
...
| **Vendor** | Cloud Contraptions |
    ...
    | **Duration** | 5 days |
    | **Audience** | Students need HTML, CSS, JavaScript, and C# programming experience. The course can be taught with EF Core or Dapper for database access. |
...
## Resources
    ...
    - [Course Page](https://www.cloudcontraptions.com/courses/frameworks/blazor/build-dotnet10-web-apps-with-blazor-and-minimal-api/)
    - [Vendor Website](https://www.cloudcontraptions.com/courses/frameworks/blazor/build-dotnet10-web-apps-with-blazor-and-minimal-api/)
